...
export const MATCHES = [
  ...
  { id: 'm4', lot: 'l4', score: 84, why: 'Близко по стоимости, владелец открыт к гаджетам', topup: 3000, dir: 'they-pay' },
];
...
export const CHAT_MSGS = [
  ...
  { from: 'me',   text: 'Привет! Да, всё верно. AI оценил часы в 38 000, доплачу 10 000 баллами.', t: '14:05' },
