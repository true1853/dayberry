...
const WANTS_SYSTEM_PROMPT = `Ты — помощник бартерной платформы «Дай бери». Помогаешь пользователю сформулировать список «что я хочу получить в обмен» (хотелки) для его профиля.
